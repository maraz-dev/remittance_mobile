...
class InitiateForgotPasswordNotifier extends AutoDisposeAsyncNotifier<bool> {
  Future<void> initiateForgotPasswordMethod(InitiateForgotPassReq req) async {
    state = const AsyncLoading();
    state =
        await AsyncValue.guard(() => ref.read(authRepository).initiateForgotPasswordEndpoint(req));
  }
...
final initiateForgotPasswordProvider =
    AsyncNotifierProvider.autoDispose<InitiateForgotPasswordNotifier, bool>(
