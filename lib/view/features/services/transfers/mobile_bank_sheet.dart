...
class MobileBanksSheet extends ConsumerStatefulWidget {
  final String country;
  const MobileBanksSheet({
    super.key,
    required this.country,
  });

  @override
  ConsumerState<MobileBanksSheet> createState() => _BanksSheet();
}

class _BanksSheet extends ConsumerState<MobileBanksSheet> {
  ...
  Widget build(BuildContext context) {
    ...
    final banks = ref.watch(getMobileBanksProvider(widget.country));
        ...
        child: Column(
          ...
          children: [
            Row(
              ...
              children: [
                const SectionHeader(text: 'Choose Mobile Money'),
                InkWell(
                  onTap: () => context.pop(),
